                            ...
                            <div class="card-body">
                                <table class="table table-striped table-bordered">
                                    <tbody>
                                        ...
                                        @endif
                                        @if ($inquiry->frm_date != null)
                                            <tr>
                                                <th> Date </th>
                                                <td> {{ date('F d, Y', strtotime($inquiry->frm_date)) }} </td>
                                            </tr>
                                        @endif
                                        ...
                                        @endif
                                         @if ($inquiry->levelofdance != null)
                                            <tr>
                                                <th> Level Of Dance </th>
                                                <td> {{ $inquiry->levelofdance }} </td>
                                            </tr>
                                        @endif
                                        ...
                                        @endif
                                        @if ($inquiry->section != null)
                                            <tr>
                                                <th> Section </th>
                                                <td> {{ $inquiry->section }} </td>
                                            </tr>
                                        @endif
