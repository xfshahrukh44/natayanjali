            		...
            		<div class="row justify-content-center align-items-cenetr">
            			<div class="col-xxl-10 col-xl-11 col-lg-11 col-md-12">
            						...
            						<div class="col-lg-12">
            							<nav class="navbar navbar-expand-lg navbar-dark">
            								...
            								<div class="collapse navbar-collapse" id="navbarSupportedContent">
            									...
            									<form class="d-flex">
            										<input class="form-control" type="search" placeholder="Search Somethings.." aria-label="Search"> </form>
            								</div>
            							</nav>
            						</div>
            					</div>
            				...
            				<section class="blog-list">
            					...
            					<div class="fleft">
            						<p>- Copyright © 2023 <a href="javascript:;">Shingeki No Kyojin</a> - <a href="javascript:;" rel="nofollow">Blogger Templates</a> - Powered by <a href="javascript:;">Blogger</a> - Designed by <a href="javascript:;" title="johanes djogan">Johanes Djogan</a> - </p>
            					</div>
            				</section>
            			</div>
            		</div>
