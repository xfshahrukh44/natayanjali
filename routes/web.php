...
Route::get('/director','HomeController@director')->name('director');
Route::get('/press-reviews','HomeController@pressReviews')->name('pressReviews');
Route::get('/performance-history','HomeController@performHistory')->name('performanceHistory');
Route::get('/biography-video','HomeController@biographyVideo')->name('biographyVideo');
Route::get('class-description/{slug}','HomeController@classDesc')->name('classDesc');
Route::get('gallery','HomeController@gallery')->name('gallery');
Route::get('instructor','HomeController@instructor')->name('instructor');
Route::get('class-register','HomeController@classregister')->name('classregister');
Route::get('the-free-consultation','HomeController@classregister')->name('thefreeconsultation');
Route::get('blogs','HomeController@blogs')->name('blogs');
Route::get('blog-category/{id}','HomeController@blog_category')->name('blog-category');
Route::get('blogDetail/{id}', 'HomeController@blogDetail')->name('blogDetail');
Route::get('events','HomeController@upcomingEvents')->name('upcomingEvent');
Route::get('concluded','HomeController@concluded')->name('concluded');
Route::get('class-offered','HomeController@classOffered')->name('classOffered');
Route::get('school-policy','HomeController@schoolPolicy')->name('schoolPolicy');
Route::get('faq','HomeController@faq')->name('faq');
Route::get('location','HomeController@location')->name('location');
Route::get('bharat-natayam','HomeController@bharatNatyamPage')->name('bharatNatyam');
Route::get('origin-of-Bharata-natyam','HomeController@origin_of_Bharata_natyam')->name('origin-of-Bharata-natyam');
Route::get('dance-came-to-be-practiced','HomeController@dance_came_to_be_practiced')->name('dance-came-to-be-practiced');
Route::get('revival-of-bharata-natyam','HomeController@revival_of_bharata_natyam')->name('revival-of-bharata-natyam');
...
Route::resource('dance-class/dance-class', 'danceclass\DanceClassController');

Route::resource('what-we-do/what-we-do', 'Admin\WhatWeDoController');

Route::resource('faqs/faq', 'Admin\FaqController');
Route::resource('video/video', 'Admin\VideoController');

Route::resource('gallery/gallery', 'Admin\GalleryController');
Route::resource('instructor/instructor', 'Admin\InstructorController');

Route::resource('admin/events', 'Admin\EventsController');

Route::resource('admin/ticket', 'Admin\TicketController');

Route::resource('admin/play-list', 'Admin\PlayListController');
Route::resource('admin/tutorial-video', 'Admin\TutorialVideoController');
